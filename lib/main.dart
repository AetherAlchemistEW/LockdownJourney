...
class _MyAppState extends State<MyApp> {
  Stream<LockdownJourneyFirebaseUser> userStream;
  LockdownJourneyFirebaseUser initialUser;

  @override
  void initState() {
    super.initState();
    userStream = lockdownJourneyFirebaseUserStream()
