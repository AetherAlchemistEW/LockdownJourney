...
import 'schema/fleet_record.dart';
...
export 'schema/fleet_record.dart';
...
Stream<List<ActivitiesRecord>> queryActivitiesRecord(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(ActivitiesRecord.collection, ActivitiesRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Stream<List<FleetRecord>> queryFleetRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(FleetRecord.collection, FleetRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
