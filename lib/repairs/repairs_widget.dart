...
class RepairsWidget extends StatefulWidget {
  RepairsWidget({Key key}) : super(key: key);

  @override
  _RepairsWidgetState createState() => _RepairsWidgetState();
}

class _RepairsWidgetState extends State<RepairsWidget> {
                            ...
                            return ToggleIcon(
                              onPressed: () async {
                                final activitiesUpdateData =
                                  ...
                                  repairs: !toggleIconActivitiesRecord.repairs,
                                );
                                await toggleIconActivitiesRecord.reference
                                    .update(activitiesUpdateData);
                              },
                              value: toggleIconActivitiesRecord.repairs,
                              onIcon: Icon(
